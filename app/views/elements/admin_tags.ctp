...
echo
	$html->div('addTag'),
		...
		$form->input('addTag',array('label'=>false,'div'=>'ib addTagText')),
	'</div>';
...
$complete = '
	var el = $("TagAddTag"+addTagCount);
	var label = $$("label[for=TagAddTag"+addTagCount+"]");
...
$moo->addEvent('addTag','keyup','addTagReady = false;',array(
	...
	'prevent'=>true,
	'spinner'=>true,
	'url'=>'/admin/tags/agregar/"+addTagCount+"',
	'oncomplete'=>$complete,
