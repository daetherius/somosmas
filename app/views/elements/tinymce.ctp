<?php
	...
	if($advanced){
	    $options = '
	    plugins : "safari,contextmenu,paste,fullscreen,table",
	    ...
	    theme_advanced_buttons2 : "bold,italic,underline,forecolor,|,formatselect,fontselect,fontsizeselect,|,bullist,numlist,|,sub,sup,cite,|,code",
    ...
    $options.=
		...
		extended_valid_elements : "a[href],img[class|src|alt|title|width|height|align|name]",
